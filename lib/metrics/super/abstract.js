...
AbstractMetric.prototype.statsDump = function() {
    throw new Error('stats method not implemented');
};

AbstractMetric.prototype.influxDump = function() {
    throw new Error('influx method not implemented');
};
...
AbstractMetric.prototype.getHandler = function() {
    throw new Error('getHandler method not implemented');
};

AbstractMetric.prototype.stop = function() {
